...
def main():
    ...
    parser.add_argument('-ternary_decay', type=float, default=0.25, help='for Ternary only: fixed membrane decay used by borrowed 三值神经元 LIFAct')
    ...
    elif args.model in ['vggsnn', 'snn5_noAP', 'dgn_dvscifar10_tiny', 'dvscifar10_fc2']:  # lightweight options for DVS-CIFAR10
