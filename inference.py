...
def main():
    ...
    parser.add_argument('-dgn_learnable_w', action='store_true', help='for DGN only: make W path learnable')
    parser.add_argument('-dgn_learnable_c', action='store_true', help='for DGN only: make C path learnable')
    ...
    neuron_kwargs = dict(
        ...
        neuron_model_name=args.neuron_model,
    ...
    if args.neuron_model == 'LSLIF':
        ...
        out_dir += (
            ...
            f'_lgl{int(args.dgn_learnable_gl)}_lw{int(args.dgn_learnable_w)}_lc{int(args.dgn_learnable_c)}'
        )
