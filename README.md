...
It proportionally traces current and earlier inputs in the real pre-threshold
decision membrane, separating the resettable main path from LS-retained history; see
...
HALIF adds heterogeneous autonomous neurons inside each LIF layer. For example:
    ...
    python train.py -data_dir ./data_dir -dataset cifar10 -model spiking_resnet18 -neuron_model HALIF -halif_auto_ratio 0.1 -halif_num_auto_groups 3
